...
class Skeleton(pygame.sprite.Sprite):
    """
    Represents an enemy skeleton character in bad_guys group.
    Attributes:
    ...
    def __init__(self, game, x, y):
        ...
        down_frames = [(0 + self.x_offset, 0 + self.y_offset), (32 + self.x_offset, 0 + self.y_offset),
                       (64 + self.x_offset, 0 + self.y_offset)]
        ...
        left_frames = [(0 + self.x_offset, 32 + self.y_offset), (32 + self.x_offset, 32 + self.y_offset),
                       (64 + self.x_offset, 32 + self.y_offset)]
        ...
        right_frames = [(0 + self.x_offset, 64 + self.y_offset), (32 + self.x_offset, 64 + self.y_offset),
                        (64 + self.x_offset, 64 + self.y_offset)]
        ...
        up_frames = [(0 + self.x_offset, 96 + self.y_offset), (32 + self.x_offset, 96 + self.y_offset),
                     (64 + self.x_offset, 96 + self.y_offset)]
        self.up_animations = [
            pygame.transform.scale(self.game.skeletons_sprite_sheet.get_sprite(*frame, self.width, self.height),
                                   (48, 48))
    ...
    def animate(self):
        if self.facing == "left":
            if self.dx == 0:
                self.image = self.game.skeletons_sprite_sheet.get_sprite(0 + self.x_offset, 96 + self.y_offset,
                                                                         self.width, self.height)
            else:
        ...
        if self.facing == "right":
            if self.dx == 0:
                self.image = self.game.skeletons_sprite_sheet.get_sprite(0 + self.x_offset, 64 + self.y_offset,
                                                                         self.width, self.height)
            else:
        ...
        if self.facing == "up":
            if self.dy == 0:
                self.image = self.game.skeletons_sprite_sheet.get_sprite(0 + self.x_offset, 32 + self.y_offset,
                                                                         self.width, self.height)
            else:
        ...
        if self.facing == "down":
            if self.dy == 0:
                self.image = self.game.skeletons_sprite_sheet.get_sprite(0 + self.x_offset, 0 + self.y_offset,
                                                                         self.width, self.height)
            else:
